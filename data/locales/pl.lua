locale = {
  ...
  translation = {
    ...
    -- missing translations below
    ["Open containers maximized"] = "Open containers maximized",
    ["Highlight mouse target"] = "Highlight mouse target",
    ["Crosshair:"] = "Crosshair:",
    ["General"] = "General",
    ["Move stacks directly"] = "Move stacks directly",
    ["Enable precise control"] = "Enable precise control",
    ["You will have more precision over the character walking,\nbut it can feel more abrupt or unnatural"] = "You will have more precision over the character walking,\nbut it can feel more abrupt or unnatural",
    ...
    ["Draw Effect On Top"] = "Draw Effect On Top",
    ["Draw effect after drawing the entire floor."] = "Draw effect after drawing the entire floor.",
    ...
    ["Floor Shadowing Intensity: %s%%"] = "Floor Shadowing Intensity: %s%%",
    ["Floor Fading: %s ms"] = "Floor Fading: %s ms",
    ["Auto Reload"] = "Auto Reload",
    ["Check this option so that the module is automatically reloaded when it is modified."] = "Check this option so that the module is automatically reloaded when it is modified.",
    ["Preys"] = "Preys",
    ...
    ["Toggle WASD chat mode"] = "Toggle WASD chat mode",
    ["Attack next creature in battle list"] = "Attack next creature in battle list",
    ["Attack previous creature in battle list"] = "Attack previous creature in battle list",
    ["Toggle chase mode"] = "Toggle chase mode",
    ["Hotkey Action"] = "Hotkey Action",
    ["Mana Leech Chance"] = "Mana Leech Chance",
    ["Mana Leech Amount"] = "Mana Leech Amount",
    ["Sell History"] = "Sell History",
    ["Buy History"] = "Buy History",
    ["Health circle"] = "Health circle",
    ["On health circle"] = "On health circle",
    ["Mana circle"] = "Mana circle",
    ["On mana circle"] = "On mana circle",
    ["Experience circle"] = "Experience circle",
    ["On experience circle"] = "On experience circle",
    ["Skill circle"] = "Skill circle",
    ["On skill circle"] = "On skill circle",
    ["Skill:"] = "Skill:",
    ["Choose skill to show in skill circle."] = "Choose skill to show in skill circle.",
    ["Set distance from center."] = "Set distance from center.",
    ["Set circle opacity."] = "Set circle opacity.",
    ["HP/MP Circle"] = "HP/MP Circle",
    ["Opacity: %s"] = "Opacity: %s",
    ["Floor Fading: %s ms"] = "Floor Fading: %s ms",
